...
#define myDEFINE_GUID(n,l,w1,w2,b1,b2,b3,b4,b5,b6,b7,b8) static const GUID n GUID_SECT = {l,w1,w2,{b1,b2,b3,b4,b5,b6,b7,b8}}
myDEFINE_GUID(myIID_IDirectDraw2, 0xB3A6F3E0,0x2B43,0x11CF,0xA2,0xDE,0x00,0xAA,0x00,0xB9,0x33,0x56);
myDEFINE_GUID(myIID_IDirectDrawSurface3, 0xDA044E00,0x69B2,0x11D0,0xA1,0xD5,0x00,0xAA,0x00,0xB8,0xDF,0xBB);
...
static int ddraw_init_directdraw(ddraw_window* win, int level) {
	...
	TRYDD(IDirectDraw_QueryInterface(dd, &myIID_IDirectDraw2, &win->dd2),
...
static int ddraw_init_primary(ddraw_window* win, LPDDSURFACEDESC desc) {
	...
	TRYDD(IDirectDrawSurface_QueryInterface(surface, &myIID_IDirectDrawSurface3, &win->surface3),
...
static int ddraw_display_init_windowed (unsigned int width, unsigned int height, char *title) {
	...
	TRYDD(IDirectDrawSurface_QueryInterface(backsurface, &myIID_IDirectDrawSurface3,
